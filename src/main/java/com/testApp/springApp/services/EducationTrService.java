...
public class EducationTrService {
    ...
    public List<EducationTrDto> createEducationTr(EducationTrDto educationTrDto) {
        List<EducationTrDto> educationTrDtoList = new ArrayList<>();
        ...
        educationTrDtoList.add(educationTrDto);
        return educationTrDtoList;
    }
